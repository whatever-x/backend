package com.whatever.caramel.domain.sample.service
...
import com.whatever.caramel.domain.sample.exception.SampleNotFoundException
    ...
    fun testSignIn(email: String, expSec: Long): SignInVo {
        val testUser = sampleUserRepository.findByEmailAndIsDeleted(email)
            ?: throw SampleNotFoundException(
                errorCode = com.whatever.caramel.domain.sample.exception.SampleExceptionCode.SAMPLE_CODE,
