...
class BirthDateNotificationSchedulerTest {
    ...
    private lateinit var scheduler: BirthDateNotificationScheduler
    ...
    fun supports() {
        ...
        // then
        assertThat(supportType).isEqualTo(CoupleAnniversaryType.BIRTHDAY)
    }
    ...
    fun schedule() {
        ...
        val ownerId = 1L
        val memberIds = setOf(ownerId, 2L)
        val notifyAt = today.toDateTime()
        val scheduleParameter = BirthDateNotificationSchedulingParameter(
            anniversaryItem = MemberAnniversaryItem(
                ownerId = ownerId,
    ...
    fun schedule_WithInvalidParameterType_ThenThrowException() {
        ...
        val today = LocalDate.of(2025, 8, 7)
        val notifyAt = today.toDateTime()
        val invalidParameter = mockk<CoupleNotificationSchedulingParameter>()
