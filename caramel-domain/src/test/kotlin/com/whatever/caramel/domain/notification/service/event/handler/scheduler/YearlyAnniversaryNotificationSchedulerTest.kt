...
class YearlyAnniversaryNotificationSchedulerTest {
    ...
    private lateinit var scheduler: YearlyAnniversaryNotificationScheduler
    ...
    fun supports() {
        ...
        // then
        assertThat(supportType).isEqualTo(CoupleAnniversaryType.YEARLY)
    }
