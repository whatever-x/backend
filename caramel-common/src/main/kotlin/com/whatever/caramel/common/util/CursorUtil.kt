...
object CursorUtil {
    ...
    fun fromHash(cursorHash: String): List<String> {
        ...
        return decodedString.split(com.whatever.caramel.common.util.CursorUtil.SEPARATOR)
    }

    fun toHash(vararg cursors: Any): String {
        return cursors.joinToString(com.whatever.caramel.common.util.CursorUtil.SEPARATOR) { it.toString() }
